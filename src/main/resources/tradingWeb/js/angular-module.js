...
app.controller('CreateTradeCtrl', function ($http, $location, $uibModalInstance, $uibModal, demoApp, apiBaseURL, peers, $loadingOverlay) {
    ...
    modalInstance.create = () => {
        ...
        if (invalidFormInput()) {
            ...
            const createTradeEndpoint = `${apiBaseURL}create-trade?counterParty=${modalInstance.form.counterparty}&ticker=${modalInstance.form.ticker}&side=${modalInstance.form.side}&amount=${modalInstance.form.amount}&price=${modalInstance.form.price}&tradeStatus=PENDING`;
    ...
    function invalidFormInput() {
        return isNaN(modalInstance.form.amount) || (modalInstance.form.counterparty === undefined);
    }
});
